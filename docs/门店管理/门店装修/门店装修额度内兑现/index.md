...
<tbody>
<tr><td>兑现金额超过剩余可兑额度</td><td>保存时</td><td>inThisCashoutAmt&gt;inThisSurCashoutAmt</td><td>中</td><td style="text-align:center;"><a href="#err-detail-1" class="view-btn">查看</a></td></tr>
<tr><td>验收报销单不存在</td><td>保存时</td><td>checkBxId对应的验收报销单不存在</td><td>高</td><td style="text-align:center;"><a href="#err-detail-2" class="view-btn">查看</a></td></tr>
<tr><td>单据信息不存在</td><td>批量复核查询/删除/审批回调</td><td>批量复核单cashId对应FIN_FEE_IN_CASH_HEAD记录不存在</td><td>高</td><td style="text-align:center;"><a href="#err-detail-3" class="view-btn">查看</a></td></tr>
<tr><td>验收报销单号和门头兑现单号为空</td><td>推送共享</td><td>兑现单关联的checkBxCode和dhCashoutNo均为空</td><td>高</td><td style="text-align:center;"><a href="#err-detail-4" class="view-btn">查看</a></td></tr>
<tr><td>验收单号X，总账日期不能为空，请检查</td><td>批量复核提交</td><td>关联的兑现单ledgerDate为空</td><td>高</td><td style="text-align:center;"><a href="#err-detail-5" class="view-btn">查看</a></td></tr>
</tbody>
</table>
</KbCard>
