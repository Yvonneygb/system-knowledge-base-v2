...
<KbCard title="常见问题">
<ul><li>问题1：完成率为0</li><li>原因：该合同无出库数据或任务金额为0</li><li>解决思路：检查SQL <code>SELECT TASK_AMT, DELIVERY_AMT FROM EPM_PROJECT_CONTRACT WHERE CONTRACT_CODE = #&#123;code&#125;</code></li></ul>
</KbCard>
