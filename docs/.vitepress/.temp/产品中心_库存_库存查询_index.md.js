...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"\u4EA7\u54C1\u4E2D\u5FC3/\u5E93\u5B58/\u5E93\u5B58\u67E5\u8BE2/index.md"}');
const _sfc_main = { name: "\u4EA7\u54C1\u4E2D\u5FC3/\u5E93\u5B58/\u5E93\u5B58\u67E5\u8BE2/index.md" };
...
<span class="line"${_scopeId}></span></code></pre></div>`);
        ...
        return [
          ...
          createVNode("ul", null, [
            ...
            createVNode("li", null, [
              ...
              createTextVNode('\uFF1A\u672C\u83DC\u5355\u4E0E"\u4E8B\u4E1A\u90E8\u5E93\u5B58\u67E5\u8BE2"\u5171\u7528\u540C\u4E00\u524D\u7AEF\u9875\u9762\u548C\u540E\u7AEF\u63A5\u53E3\u3002\u540E\u7AEF\u8D70selectList/selectListDMS\u63A5\u53E3\u67E5\u8BE2LNK_INVENTORY\u8868\uFF0C\u82E5\u540E\u7AEF\u670D\u52A1\u4E0D\u53EF\u7528\u3001\u6570\u636E\u5E93\u8FDE\u63A5\u8D85\u65F6\u3001Oracle\u51FD\u6570cux_inv_convert_ex_pub.inv_um_convert\u6267\u884C\u5F02\u5E38\u7B49\uFF0C\u5747\u4F1A\u5BFC\u81F4\u8BF7\u6C42\u5931\u8D25\u3002\u524D\u7AEF\u6355\u83B7\u5F02\u5E38\u540Etoast\u63D0\u793A\u3002')
            ]),
            createVNode("li", null, [
  ...
  _push(ssrRenderComponent(_component_KbCard, { title: "\u5E38\u89C1\u95EE\u9898" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<ul${_scopeId}><li${_scopeId}>\u95EE\u98981\uFF1A\u672C\u83DC\u5355\u4E0E&quot;\u4E8B\u4E1A\u90E8\u5E93\u5B58\u67E5\u8BE2&quot;\u7684\u533A\u522B</li><li${_scopeId}>\u539F\u56E0\uFF1A\u4E24\u4E2A\u83DC\u5355\u5171\u7528\u540C\u4E00\u524D\u7AEF\u9875\u9762\u548C\u540E\u7AEF\u63A5\u53E3\uFF0C\u4E3A\u540C\u4E00\u529F\u80FD\u7684\u4E0D\u540C\u83DC\u5355\u5165\u53E3</li><li${_scopeId}>\u89E3\u51B3\u601D\u8DEF\uFF1A\u65E0\u9700\u533A\u5206\uFF0C\u4E24\u4E2A\u83DC\u5355\u529F\u80FD\u5B8C\u5168\u4E00\u81F4</li></ul><ul${_scopeId}><li${_scopeId}>\u95EE\u98982\uFF1A\u67E5\u8BE2\u7ED3\u679C\u4E2D\u5E93\u5B58\u6570\u91CF\u4E3A0\u6216\u4F4E\u4E8E\u5B9E\u9645\u5E93\u5B58</li><li${_scopeId}>\u539F\u56E0\uFF1A\u5E93\u5B58\u4E0A\u9650\u914D\u7F6E\uFF08LNK_INV_MAX\uFF09\u9650\u5236\u4E86\u5C55\u793A\u6570\u91CF\u3002\u6392\u67E5SQL\uFF1A</li></ul><div class="language-sql"${_scopeId}><button title="Copy Code" class="copy"${_scopeId}></button><span class="lang"${_scopeId}>sql</span><pre class="shiki"${_scopeId}><code${_scopeId}><span class="line"${_scopeId}><span style="${ssrRenderStyle({ "color": "#F78C6C" })}"${_scopeId}>SELECT</span><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"${_scopeId}> lim.PROD_ID, lim.DEPT_ID, lim.MAXIMUN, lim.TYPE</span></span>
...
<span class="line"${_scopeId}></span></code></pre></div><ul${_scopeId}><li${_scopeId}>\u89E3\u51B3\u601D\u8DEF\uFF1A\u68C0\u67E5Oracle\u8F6C\u6362\u7387\u51FD\u6570\u662F\u5426\u6B63\u786E\u90E8\u7F72\uFF0C\u786E\u8BA4\u4EA7\u54C1\u7684\u5355\u4F4D\u914D\u7F6E</li></ul>`);
      } else {
        return [
          createVNode("ul", null, [
            createVNode("li", null, '\u95EE\u98981\uFF1A\u672C\u83DC\u5355\u4E0E"\u4E8B\u4E1A\u90E8\u5E93\u5B58\u67E5\u8BE2"\u7684\u533A\u522B'),
            createVNode("li", null, "\u539F\u56E0\uFF1A\u4E24\u4E2A\u83DC\u5355\u5171\u7528\u540C\u4E00\u524D\u7AEF\u9875\u9762\u548C\u540E\u7AEF\u63A5\u53E3\uFF0C\u4E3A\u540C\u4E00\u529F\u80FD\u7684\u4E0D\u540C\u83DC\u5355\u5165\u53E3"),
            createVNode("li", null, "\u89E3\u51B3\u601D\u8DEF\uFF1A\u65E0\u9700\u533A\u5206\uFF0C\u4E24\u4E2A\u83DC\u5355\u529F\u80FD\u5B8C\u5168\u4E00\u81F4")
          ]),
          createVNode("ul", null, [
            createVNode("li", null, "\u95EE\u98982\uFF1A\u67E5\u8BE2\u7ED3\u679C\u4E2D\u5E93\u5B58\u6570\u91CF\u4E3A0\u6216\u4F4E\u4E8E\u5B9E\u9645\u5E93\u5B58"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("\u4EA7\u54C1\u4E2D\u5FC3/\u5E93\u5B58/\u5E93\u5B58\u67E5\u8BE2/index.md");
