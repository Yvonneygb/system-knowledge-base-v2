...
<h5>排查SQL</h5>
    <pre class="detail-sql language-sql" v-pre><code>SELECT ecc.CONTRACT_COMPLETED_ID, ecc.COMPLETED_CODE, ecc.PROJECT_ID, ecc.ACTION_TYPE,
...
<div id="err-detail-2" class="error-detail-overlay">
  <div class="error-detail-box" v-pre>
    <a href="#" class="close-btn">&times;</a>
    <h4><span style="color:#7C3AED;">报错：</span>项目状态不允许结案</h4>
    <h5>详细逻辑</h5>
...
<h5>排查SQL</h5>
    <pre class="detail-sql language-sql" v-pre><code>SELECT ep.PROJECT_ID, ep.PROJECT_CODE, ep.PROJECT_VALID, ep.PROJECT_STAGE_TYPE,
...
<div id="err-detail-3" class="error-detail-overlay">
  <div class="error-detail-box" v-pre>
    <a href="#" class="close-btn">&times;</a>
    <h4><span style="color:#7C3AED;">报错：</span>结案原因必填</h4>
    <h5>详细逻辑</h5>
...
<h5>排查SQL</h5>
    <pre class="detail-sql language-sql" v-pre><code>SELECT ecc.CONTRACT_COMPLETED_ID, ecc.COMPLETED_CODE, ecc.COMPLETED_DESC, ecc.HZ_APPROVE_STATUS
  FROM EPM_CONTRACT_COMPLETED ecc
...
<div id="err-detail-4" class="error-detail-overlay">
  <div class="error-detail-box" v-pre>
    <a href="#" class="close-btn">&times;</a>
    <h4><span style="color:#7C3AED;">报错：</span>将报备状态推送到CRM推送失败</h4>
    <h5>详细逻辑</h5>
...
<h5>排查SQL</h5>
    <pre class="detail-sql language-sql" v-pre><code>SELECT er.REPORT_ID, er.PROJECT_ID, er.CUSTOMER_ID, er.CUSTOMER_CODE, er.CUSTOMER_NAME,
...
<div id="err-detail-5" class="error-detail-overlay">
  <div class="error-detail-box" v-pre>
    <a href="#" class="close-btn">&times;</a>
    <h4><span style="color:#7C3AED;">报错：</span>NullPointerException: stageDefs.get(0)</h4>
    <h5>详细逻辑</h5>
...
<h5>排查SQL</h5>
    <pre class="detail-sql language-sql" v-pre><code>SELECT esd.STAGE_ID, esd.STAGE_NAME, esd.ORGANIZATION_ID, esd.STAGE_DESC
...
<div id="err-detail-6" class="error-detail-overlay">
  <div class="error-detail-box" v-pre>
    <a href="#" class="close-btn">&times;</a>
    <h4><span style="color:#7C3AED;">报错：</span>NullPointerException: epmReports.get(0)</h4>
    <h5>详细逻辑</h5>
...
<h5>排查SQL</h5>
    <pre class="detail-sql language-sql" v-pre><code>SELECT ep.PROJECT_ID, ep.PROJECT_CODE, ep.PROJECT_NAME, ep.PROJECT_VALID,
...
<div id="err-detail-7" class="error-detail-overlay">
  <div class="error-detail-box" v-pre>
    <a href="#" class="close-btn">&times;</a>
    <h4><span style="color:#7C3AED;">报错：</span>NullPointerException: customer.getShortName()</h4>
    <h5>详细逻辑</h5>
...
<h5>排查SQL</h5>
    <pre class="detail-sql language-sql" v-pre><code>SELECT er.REPORT_ID, er.PROJECT_ID, er.CUSTOMER_ID, er.CUSTOMER_CODE,
...
<div id="err-detail-8" class="error-detail-overlay">
  <div class="error-detail-box" v-pre>
    <a href="#" class="close-btn">&times;</a>
    <h4><span style="color:#7C3AED;">报错：</span>NullPointerException: epmProjectContract</h4>
    <h5>详细逻辑</h5>
...
<h5>排查SQL</h5>
    <pre class="detail-sql language-sql" v-pre><code>SELECT ecc.CONTRACT_COMPLETED_ID, ecc.COMPLETED_CODE, ecc.CONTRACT_ID, ecc.ACTION_TYPE,
...
<div id="err-detail-9" class="error-detail-overlay">
  <div class="error-detail-box" v-pre>
    <a href="#" class="close-btn">&times;</a>
    <h4><span style="color:#7C3AED;">报错：</span>NullPointerException: epmProject</h4>
    <h5>详细逻辑</h5>
